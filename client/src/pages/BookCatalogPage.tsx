...
import { useBooksStore, selectFilteredBooks, selectBooksLoading, selectBooksError } from '@/store/useBooksStore';
    ...
    <Layout>
      <div className="container mx-auto px-4 py-8">
        ...
        {isLoading && books.length === 0 ? (
          ...
          <BookGrid books={books} title="All books" viewAllLink="/books" columns={6} emptyMessage="No books in the catalog." />
        )}
      </div>
    </Layout>
  );
