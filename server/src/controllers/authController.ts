...
import { ErrorHandler, catchAsyncErrors } from '../middlewares/errorMiddleware';
import sendVerificationCode from '../utils/sendVerificationCode';
import bcrypt from 'bcryptjs';
import { sendToken } from '../utils/sendToken';
import sendEmail from '../utils/sendEmail';
import { generateForgotPasswordEmailTemplate } from '../utils/emailTemplates';
...
export const resetPassword = catchAsyncErrors(
  async (req: AuthRequest, res: Response, next: NextFunction) => {
    ...
    if (
      ...
      req.body.confirmPassword.length > 12
    ) {
      return next(
        new ErrorHandler(
          'Password must be at least 6 characters and less than 12 characters',
